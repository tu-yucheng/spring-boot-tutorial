...
![example workflow](https://github.com/tu-yucheng/spring-boot-tutorial/actions/workflows/maven-ci.yml/badge.svg)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=tu-yucheng_taketoday-tutorial4j&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=tu-yucheng_spring-boot-tutorial)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=tu-yucheng_taketoday-tutorial4j&metric=coverage)](https://sonarcloud.io/dashboard?id=tu-yucheng_spring-boot-tutorial)
[![Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=tu-yucheng_taketoday-tutorial4j&metric=ncloc)](https://sonarcloud.io/project/overview?id=tu-yucheng_spring-boot-tutorial)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=tu-yucheng_taketoday-tutorial4j&metric=bugs)](https://sonarcloud.io/summary/new_code?id=tu-yucheng_spring-boot-tutorial)
[![All Contributors](https://img.shields.io/badge/all_contributors-2-orange.svg?style=flat-square)](#contributors)

这个项目涵盖了Spring Boot的示例代码，包括Spring Boot核心内容、Starter以及与其他第三方库的集成。
...
要从仓库的根目录构建特定模块，请在根目录中运行命令：`mvn clean install --pl spring-boot-actuator,spring-boot-admin -Punit`。

这里的spring-boot-actuator和spring-boot-admin是我们要构建的模块，unit是要执行的测试类型的Maven profile。
