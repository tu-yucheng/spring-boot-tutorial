...
public class KongAdminAPILiveTest {
   ...
   public void givenAdminAPIProxy_whenAddAPIViaProxy_thenAPIAdded() throws Exception {
      ...
      APIObject tuyuchengAPI = new APIObject("tuyucheng-api", "tuyucheng.com", "http://ww.tuyucheng.com", "/");
      RequestEntity<APIObject> requestEntity = new RequestEntity<>(tuyuchengAPI, headers, HttpMethod.POST, new URI("http://localhost:8000/admin-api/apis"));
