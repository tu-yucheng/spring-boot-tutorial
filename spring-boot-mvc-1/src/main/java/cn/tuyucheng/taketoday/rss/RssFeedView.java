...
public class RssFeedView extends AbstractRssFeedView {
   ...
   protected void buildFeedMetadata(Map<String, Object> model, Channel feed, HttpServletRequest request) {
      feed.setTitle("Tuyucheng RSS Feed");
      feed.setDescription("Learn how to program in Java");
      feed.setLink("http://www.tuyucheng.com");
   }
   ...
   protected List<Item> buildFeedItems(Map<String, Object> model, HttpServletRequest request,
      ...
      entryOne.setLink("http://www.tuyucheng.com/junit-5-test-annotation");
      ...
      entryTwo.setLink("http://www.tuyucheng.com/jetty-java-programmatic");
      ...
      entryThree.setLink("http://www.tuyucheng.com/java-flyweight");
      ...
      entryFour.setLink("http://www.tuyucheng.com/java-multi-swarm-algorithm");
      ...
      entryFive.setLink("http://www.tuyucheng.com/mongodb-tagging");
      ...
      entrySix.setLink("http://www.tuyucheng.com/java-singleton-double-checked-locking");
      ...
      entrySeven.setLink("http://www.tuyucheng.com/dagger-2");
